...
icon = Image.open("C:\\Users\\shaml\\PycharmProjects\\pythonProject1\\youtube_logo.png")
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing | By SHYMALA",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This app is created by *SHYMALA!*"""})
...
db = client.Youtube_Data_SHYMALA
# CONNECTING WITH MYSQL DATABASE
mydb = sql.connect(host="127.0.0.1",
                   user="root",
                   password="Shymala@5466",
...
api_key = "AIzaSyAN9R_eAc8gM74I6POV6MNb6I_sa8h0zmg"  # "AIzaSyAN9R_eAc8gM74I6POV6MNb6I_sa8h0zmgs"
...
if selected == "Home":
    # Title Image
    st.image("C:\\Users\shaml\\PycharmProjects\\pythonProject1\\youtube_logo.png")
